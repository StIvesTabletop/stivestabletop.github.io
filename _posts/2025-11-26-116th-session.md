...
Something rising from the past, a classic in the worker placement genre came back to the table [Lords of Waterdeep][LoW] (although it was last played in [session 111][111], so not that long ago for the club this game hails from 2012). At its core, Lords of Water deep is a classic worker placement; you have a number of workers that activate spaces. The spaces generate resources to fulfill quests, allow you to draw more quests, or add/manipulate action spaces by adding new buildings. We played with the expansion Scoundrels of Skullport (one of those often cited examples of expansions that "fix" the base game), the expansion adds a new wrinkle to the game, corruption, with new buildings and new quests -- adding that much needed variety and some interesting alternative plays. The question is, how can you do the most with the limited moves you have while avoiding being blocked out of important spaces.
...
There wwere some wild point jumps as early scoring was quickly surpassed by 20 and 40 point quests. Corruption was ever present and one player seemed to wallow in it... ultimately taking their final score to historic lows.

The game is sadly long out of print, mainly due to being licensed with the D&D Waterdeep theme... although, if that were taken away the underlying game is rather setting agnostic. It might be said that this is one place the game falls down; the "resources" are "adventurers (read cubes)" and the quests are akin to "contracts" in many similar games. You never get a sense that the many cubes are adventurers taming wild lands.
